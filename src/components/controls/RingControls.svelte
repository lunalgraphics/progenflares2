<!-- Control panel section for ring artifact settings -->
<script>
  ...
  /** @type {Object} Ring settings object (bound from parent) */
  export let settings;

  /** Notify parent that settings changed and ring needs re-render */
  function update() {
    dispatch("change");
  }
</script>
